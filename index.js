...
const image = nativeImage.createFromPath(
  ...
  path.join(__dirname, `images/icon.iconset/icon_16x16.png`)
);
  ...
  mb.on("ready", () => {
    ...
    const contextMenuTemplate = [
      ...
      },
      {
        ...
        click: () => {
          shell.openExternal("https://twitter.com/kentoak1");
        },
      },
    ];
    ...
    globalShortcut.register('esc', () =>  mb.app.hide()); //written by taoka on 2023/03/13
